 ...
 */
public class update_webcam extends javax.swing.JFrame {

    /**
     * Creates new form update_webcam
     */
    public update_webcam() {
        initComponents();

        websource = new VideoCapture(0);
        myThread = new update_webcam.DaemonThread(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == 0) {
            try {
                ...
                update_records.jTextField2.setText(Filename);
                ...
                update_records.photo = baos.toByteArray();
                dispose();
            } catch (Exception e) {
                stopCam();
            }
        ...
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(
                        update_records.jLabel3.getWidth(),
                        update_records.jLabel3.getHeight(), Image.SCALE_DEFAULT));
                update_records.jLabel3.setIcon(imageico);
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_webcam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_webcam().setVisible(true);
            }
        });
    }
